...
| # | Aula | Rodar | Ensina |
|---|---|---|---|
| 01 | [Fundamentos](docs/aulas/001-fundamentos.md) | `python3 ex1.py` | espera × esforço · `gather` × `TaskGroup` · fila, semáforo, timeout, fim de turno |
| 02 | [POO e geradores](docs/aulas/002-poo-e-geradores.md) | `python3 ex2.py` | organograma de responsabilidades · receita como `Iterator[Step]` · `@asynccontextmanager` · armadilhas de gerador |
| 03 | [Restaurante completo](docs/aulas/003-restaurante-completo.md) | `python3 -m ex3` | comanda com cursos · EDF sem starvation · praças independentes · validador de fronteira |
| 04 | [Salão vivo](docs/aulas/004-salao-vivo.md) | `python3 -m ex4` | porta declarada pelo consumidor · chegadas de Poisson · drink como task paralela · desistência |
| 05 | [Medir antes de otimizar](docs/aulas/005-medir-antes-de-otimizar.md) | `python3 -m ex5` | instrumento errado mente · Teoria das Restrições · saturação não-linear |
