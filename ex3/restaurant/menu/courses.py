...
class Course(IntEnum):
    ...
    def label(self) -> str:
        ...
        `Station` abaixo, cujos valores são exatamente o que aparece no log.
        Num `IntEnum` não dá: o valor já está ocupado sendo a ORDEM do curso.
        Daí o mapa explícito — e é ele que impede um `.name.lower()` de vazar
