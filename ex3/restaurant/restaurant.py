...
class Restaurant:
    ...
    def __init__(
        ...
        *,
        ...
        self.lines: Mapping[Section, Line] = {
            Section.KITCHEN: Line(Section.KITCHEN, clock, slots=KITCHEN_STATIONS),
            Section.BAR: Line(Section.BAR, clock, slots=BAR_STATIONS),
        }
    ...
    async def __aenter__(self) -> Self:
        ...
        self._record(
            EventKind.OPENED,
            "casa",
            f"{len(self._brigade)} na cozinha/bar, {len(self.wait_staff.waiters)} no salão",
        )
        return self
